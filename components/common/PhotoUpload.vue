    ...
    <div class="flex items-center gap-4">
      ...
      <div class="relative flex-shrink-0">
        <div 
          v-if="!photoPreview"
          :class="sizeClasses"
          class="rounded-full bg-gray-200 flex items-center justify-center font-bold border-[5px] border-white shadow-md text-gray-500"
        >
          {{ initials }}
        </div>
        <img 
          ...
          'border-[5px] border-white shadow-md'
        ]"
        />
      </div>
      ...
      <div class="flex flex-col  gap-2">
        <div class="flex gap-2">
          ...
          class="border border-gray-200 font-semibold"
        >
